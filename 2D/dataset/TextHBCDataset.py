...
class HBCDataset(torch.utils.data.Dataset):
    def __init__(self, 
                 ...
                 text_path = 'select_genes/STNet_loki_text_encode.npy'
                 ): 
        if selected_genes is None:
            selected_genes_path = 'select_genes/STNet_select_genes.npy'
        ...
        for wsi_file in wsi_filenames:
            ...
            for idx, spot_info in spots_pixel_map_all.iterrows():
                center_x = spot_info['X']
                center_y = spot_info['Y']
            ...
            for i in range(len(current_wsi_spots)):
                ...
                for neighbor_idx_in_current_wsi in nearest_indices:
                    ...
                    try:
                        patch1 = get_patch_and_resize(wsi_img, neighbor_coords[0], neighbor_coords[1], crop_size_1, self.patch_size)
                        patches_9.append(patch1)
